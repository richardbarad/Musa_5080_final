...
library(ckanr) # Client For The Comprehensive Knowledge Archive Network API
...
library(spatstat.explore) # Exploratory Data Analysis of Spatial Data
library(raster) # Geographic Data Analysis and Modeling
library(grid) # Grid Pattern Grobs Filling User-Defined Area
library(gridExtra) # Miscellaneous Functions for "Grid" Graphics
library(knitr) # General-Purpose Package for Dynamic Report Generation
library(kableExtra) # Construct Complex Table with 'Kable' and Pipe Syntax
library(classInt) # Choose Univariate Risk Class Intervals (KDE & ML)
library(pscl) # Political Science Computational Laboratory: Bayesian Analysis 
...
library(raster) # Geographic Data Analysis and Modeling of Spatial Data
...
I figured our training data would be one year of data - this is 8,952 data points. I also removed all results which were not Pass or Fail.
