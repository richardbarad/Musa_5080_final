...
p_values = c(t_age,t_fails_per_year,t_Median_Rent,t_pct_non_white,t_pct_poverty,t_prev_fails,t_prev_year,t_rodents.nn,t_sanitation.nn,t_thefts)
...
cvFit <- train(
  results ~ age + prev_fails + Median_Rent + rodents.nn + sanitation.nn + thefts.nn + risk + pct_poverty + prev_year_pct_fail + decile,
  data = data_2021_2,
  method = "glm",
  family = "binomial",
  metric = "ROC",
