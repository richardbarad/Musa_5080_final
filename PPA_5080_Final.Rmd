...
```
The map on the left shows data on the outcomes of food inspections in 2021. This is the data we will use to train our model. We find that there is spatial clustering present in the location of inspection failures.
...
ggplot() +
  ...
  theme_void()
```
The map on the right shows the percent of restaurants that pass inspections. Restaurants in Garfield Park, New City and Chinatown have the highest fail rates in the city. 
